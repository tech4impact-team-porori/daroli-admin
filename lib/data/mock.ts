...
const recipients: Recipient[] = [
  { id: 'rcp-1', name: '김○○', type: RECIPIENT_TYPE.ELDER, region: '청도읍', addressDetail: '청도읍 ○○길 12-3', phone: '010-2222-0001', careNeeds: '고혈압 관리 중', managerId: 'mgr-1', createdAt: iso(2026, 2, 3, 9, 0) },
  { id: 'rcp-2', name: '이○○', type: RECIPIENT_TYPE.ELDER, region: '청도읍', addressDetail: '청도읍 ○○길 45', phone: '010-2222-0002', managerId: 'mgr-1', createdAt: iso(2026, 2, 4, 9, 0) },
  { id: 'rcp-3', name: '박○○', type: RECIPIENT_TYPE.ELDER, region: '청도읍', addressDetail: '청도읍 ○○로 8', careNeeds: '거동 약간 불편, 지팡이 사용', managerId: 'mgr-2', createdAt: iso(2026, 2, 5, 9, 0) },
  ...
  { id: 'rcp-5', name: '정○○', type: RECIPIENT_TYPE.ELDER, region: '청도읍', addressDetail: '청도읍 ○○길 3', createdAt: iso(2026, 3, 1, 9, 0), deletedAt: iso(2026, 7, 10, 9, 0) },
  { id: 'rcp-6', name: '조○○', type: RECIPIENT_TYPE.ELDER, region: '화양읍', addressDetail: '화양읍 ○○길 9', phone: '010-2222-0006', careNeeds: '당뇨 관리 중', managerId: 'mgr-4', createdAt: iso(2026, 2, 8, 9, 0) },
  { id: 'rcp-7', name: '윤○○', type: RECIPIENT_TYPE.ELDER, region: '화양읍', addressDetail: '화양읍 ○○로 14', createdAt: iso(2026, 3, 12, 9, 0) },
  { id: 'rcp-8', name: '장○○', type: RECIPIENT_TYPE.ELDER, region: '풍각면', addressDetail: '풍각면 ○○길 5', phone: '010-2222-0008', createdAt: iso(2026, 4, 2, 9, 0) },
  { id: 'rcp-9', name: '임○○', type: RECIPIENT_TYPE.CHILD, age: 7, region: '풍각면', addressDetail: '풍각면 ○○로 2', createdAt: iso(2026, 4, 5, 9, 0) },
  { id: 'rcp-10', name: '한○○', type: RECIPIENT_TYPE.ELDER, region: '금천면', addressDetail: '금천면 ○○길 11', phone: '010-2222-0010', careNeeds: '낙상 위험 - 보행 보조 필요', managerId: 'mgr-6', createdAt: iso(2026, 2, 10, 9, 0) },
  { id: 'rcp-11', name: '오○○', type: RECIPIENT_TYPE.ELDER, region: '금천면', addressDetail: '금천면 ○○로 6', managerId: 'mgr-6', createdAt: iso(2026, 2, 11, 9, 0) },
  ...
  { id: 'rcp-13', name: '신○○', type: RECIPIENT_TYPE.ELDER, region: '금천면', addressDetail: '금천면 ○○로 3', createdAt: iso(2026, 5, 1, 9, 0) },
  { id: 'rcp-14', name: '권○○', type: RECIPIENT_TYPE.ELDER, region: '매전면', addressDetail: '매전면 ○○길 7', phone: '010-2222-0014', careNeeds: '만성 관절염', managerId: 'mgr-7', createdAt: iso(2026, 1, 25, 9, 0) },
  { id: 'rcp-15', name: '황○○', type: RECIPIENT_TYPE.ELDER, region: '매전면', addressDetail: '매전면 ○○로 4', createdAt: iso(2026, 3, 20, 9, 0), deletedAt: iso(2026, 7, 15, 9, 0) },
  { id: 'rcp-16', name: '남○○', type: RECIPIENT_TYPE.ELDER, region: '각남면', addressDetail: '각남면 ○○길 2', phone: '010-2222-0016', createdAt: iso(2026, 4, 10, 9, 0) },
  { id: 'rcp-17', name: '방○○', type: RECIPIENT_TYPE.CHILD, age: 8, region: '각남면', addressDetail: '각남면 ○○로 10', createdAt: iso(2026, 4, 11, 9, 0) },
  { id: 'rcp-18', name: '유○○', type: RECIPIENT_TYPE.ELDER, region: '각남면', addressDetail: '각남면 ○○길 33', createdAt: iso(2026, 4, 12, 9, 0) },
  { id: 'rcp-19', name: '배○○', type: RECIPIENT_TYPE.ELDER, region: '각북면', addressDetail: '각북면 ○○길 6', phone: '010-2222-0019', createdAt: iso(2026, 5, 3, 9, 0) },
  { id: 'rcp-20', name: '홍○○', type: RECIPIENT_TYPE.ELDER, region: '각북면', addressDetail: '각북면 ○○로 1', createdAt: iso(2026, 5, 4, 9, 0) },
  { id: 'rcp-21', name: '문○○', type: RECIPIENT_TYPE.ELDER, region: '운문면', addressDetail: '운문면 ○○길 15', phone: '010-2222-0021', createdAt: iso(2026, 5, 20, 9, 0) },
...
const requests: CareRequest[] = [
  { id: 'req-1', recipientId: 'rcp-1', managerId: 'mgr-1', requestType: REQUEST_TYPE.RIDING, desiredAt: iso(2026, 8, 5, 9, 0), isTimeFixed: true, status: REQUEST_STATUS.COMPLETED, confirmedAt: iso(2026, 8, 5, 9, 0), createdAt: iso(2026, 8, 1, 9, 0) },
  { id: 'req-2', recipientId: 'rcp-2', managerId: 'mgr-1', requestType: REQUEST_TYPE.HOUSEWORK, desiredAt: iso(2026, 8, 14, 10, 0), isTimeFixed: false, status: REQUEST_STATUS.CONFIRMED, confirmedAt: iso(2026, 8, 14, 10, 0), createdAt: iso(2026, 8, 10, 9, 0) },
  { id: 'req-3', recipientId: 'rcp-3', requestType: REQUEST_TYPE.MEAL, desiredAt: iso(2026, 8, 16, 11, 30), isTimeFixed: false, status: REQUEST_STATUS.REQUESTED, createdAt: iso(2026, 8, 12, 9, 0) },
  { id: 'req-4', recipientId: 'rcp-4', managerId: 'mgr-2', requestType: REQUEST_TYPE.ACCOMPANY, desiredAt: iso(2026, 8, 15, 14, 0), isTimeFixed: false, status: REQUEST_STATUS.PROPOSED, proposedAt: iso(2026, 8, 15, 15, 0), createdAt: iso(2026, 8, 11, 9, 0) },
  { id: 'req-5', recipientId: 'rcp-5', requestType: REQUEST_TYPE.ETC, desiredAt: iso(2026, 8, 17, 9, 0), isTimeFixed: false, note: '미배정 지역 요청 - 배정 필요', status: REQUEST_STATUS.REQUESTED, createdAt: iso(2026, 8, 13, 9, 0) },
  { id: 'req-6', recipientId: 'rcp-6', managerId: 'mgr-4', requestType: REQUEST_TYPE.RIDING, desiredAt: iso(2026, 8, 10, 8, 30), isTimeFixed: true, status: REQUEST_STATUS.COMPLETED, confirmedAt: iso(2026, 8, 10, 8, 30), createdAt: iso(2026, 8, 6, 9, 0) },
  { id: 'req-7', recipientId: 'rcp-7', requestType: REQUEST_TYPE.HOUSEWORK, desiredAt: iso(2026, 8, 12, 13, 0), isTimeFixed: false, note: '요청자 단순 변심으로 취소', status: REQUEST_STATUS.CANCELLED, createdAt: iso(2026, 8, 8, 9, 0) },
  { id: 'req-8', recipientId: 'rcp-8', requestType: REQUEST_TYPE.MEAL, desiredAt: iso(2026, 8, 18, 12, 0), isTimeFixed: false, status: REQUEST_STATUS.REQUESTED, createdAt: iso(2026, 8, 14, 9, 0) },
  { id: 'req-9', recipientId: 'rcp-9', requestType: REQUEST_TYPE.ACCOMPANY, desiredAt: iso(2026, 8, 19, 15, 0), isTimeFixed: false, status: REQUEST_STATUS.REQUESTED, createdAt: iso(2026, 8, 14, 9, 0) },
  { id: 'req-10', recipientId: 'rcp-10', managerId: 'mgr-6', requestType: REQUEST_TYPE.RIDING, desiredAt: iso(2026, 8, 14, 9, 0), isTimeFixed: true, status: REQUEST_STATUS.CONFIRMED, confirmedAt: iso(2026, 8, 14, 9, 0), createdAt: iso(2026, 8, 9, 9, 0) },
  { id: 'req-11', recipientId: 'rcp-11', managerId: 'mgr-6', requestType: REQUEST_TYPE.HOUSEWORK, desiredAt: iso(2026, 8, 7, 10, 0), isTimeFixed: false, status: REQUEST_STATUS.COMPLETED, confirmedAt: iso(2026, 8, 7, 10, 0), createdAt: iso(2026, 8, 3, 9, 0) },
  { id: 'req-12', recipientId: 'rcp-13', requestType: REQUEST_TYPE.ETC, desiredAt: iso(2026, 8, 20, 9, 30), isTimeFixed: false, status: REQUEST_STATUS.REQUESTED, createdAt: iso(2026, 8, 15, 9, 0) },
  { id: 'req-13', recipientId: 'rcp-14', requestType: REQUEST_TYPE.MEAL, desiredAt: iso(2026, 8, 21, 11, 0), isTimeFixed: false, note: '담당 매니저 비활성화로 재배정 필요', status: REQUEST_STATUS.REQUESTED, createdAt: iso(2026, 8, 15, 9, 0) },
  { id: 'req-14', recipientId: 'rcp-16', requestType: REQUEST_TYPE.RIDING, desiredAt: iso(2026, 8, 21, 8, 0), isTimeFixed: true, status: REQUEST_STATUS.REQUESTED, createdAt: iso(2026, 8, 15, 9, 0) },
  { id: 'req-15', recipientId: 'rcp-21', requestType: REQUEST_TYPE.ACCOMPANY, desiredAt: iso(2026, 8, 22, 10, 0), isTimeFixed: false, status: REQUEST_STATUS.REQUESTED, createdAt: iso(2026, 8, 15, 9, 0) },
]
...
export const mockDataSource: DataSource = {
  async getDashboard(yearMonth) {
    ...
    const data: DashboardData = {
      ...
      elderCount: activeRecipients.filter((r) => r.type === RECIPIENT_TYPE.ELDER).length,
